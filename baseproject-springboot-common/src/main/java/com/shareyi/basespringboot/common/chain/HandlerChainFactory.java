...
public class HandlerChainFactory implements ApplicationContextAware {
     ...
     * 日志工具
     */
    static Logger LOGGER = LoggerFactory.getLogger(HandlerChainFactory.class);
    /**
     * 单例
     */
    private static HandlerChainFactory INSTANCE;
    /**
     * spring 上下文
     */
     ...
     * @return
     */
    public static HandlerChainFactory getInstance() {
        if (INSTANCE == null) {
