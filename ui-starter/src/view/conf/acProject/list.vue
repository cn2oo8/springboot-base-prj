      ...
      <Row>
        ...
        <Col span="6">
          <FormItem label="类型" prop="type">
            <dict-select v-model="formSearch.type" :kind="this.constants.dicts.dictKinds.acProject_type_DICT"
        ...
        <Col span="6">
          <FormItem label="状态3" >
            <dict-select  :kind="this.constants.dicts.dictKinds.acProject_type_DICT"
                         :clearable="true"></dict-select>
          </FormItem>
        </Col>
        ...
        <Col span="6">
          <FormItem label="状态" prop="status">
            <dict-select v-model="formSearch.status" :kind="this.constants.dicts.dictKinds.STD_BOOLEAN_DICT"
                         :clearable="true"></dict-select>
          </FormItem>
        </Col>
      </Row>
...
export default {
  ...
  methods: {
    ...
    doDelete (row) {
      var params = { 'primaryKey': row.id, token: '123456'}
      var _this = this
      this.$Modal.confirm({
        title: '删除确认',
        content: '您确定要执行删除操作吗？',
