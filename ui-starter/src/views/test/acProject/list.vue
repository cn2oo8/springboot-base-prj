                ...
                <Col span="7">
                    <FormItem label="类型" prop="type">
                        <dict-select v-model="formSearch.type"
                                     :kind="this.constants.dicts.dictKinds.acProject_type_DICT"
                ...
                <Col span="7">
                    <FormItem label="状态" prop="status">
                        <dict-select v-model="formSearch.status"
                                     :kind="this.constants.dicts.dictKinds.acProject_status_DICT"
                                     :clearable="true"></dict-select>
                    </FormItem>
                </Col>
            </Row>
            ...
            loadData () {
                ...
                this.$refs['formSearch'].validate((valid) => {
                    if (valid) {
                        ...
                        requestUtils.postSubmit(_this, constants.urls.test.acProject.list, searchParam, function (data) {
